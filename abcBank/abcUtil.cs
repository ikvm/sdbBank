...
namespace abcBank
{
    public class abcUtil
    {
        ...
        #region 额外加密
        private static string iSHA1OID = CryptoConfig.MapNameToOID("SHA1");
    
        private static string fileSignMessage(int aMerchantNo, string aMessage)
        {
            //    MerchantConfig.bundle();
          //  (RSACryptoServiceProvider)MerchantConfig.iMerchantKeys[aMerchantNo - 1];
            RSACryptoServiceProvider rSACryptoServiceProvider = MerchantConfig.MerchantKey(aMerchantNo);
            SHA1Managed sHA1Managed = new SHA1Managed();
            byte[] rgbHash = sHA1Managed.ComputeHash(Encoding.UTF8.GetBytes(aMessage.ToString()));
            //    byte[] data = rSACryptoServiceProvider.SignHash(rgbHash, MerchantConfig.iSHA1OID);
            byte[] data = rSACryptoServiceProvider.SignHash(rgbHash, iSHA1OID);
            Base64 @base = new Base64();
            string text = @base.encode(data);
            return string.Concat(new string[]
            {
                "{\"Message\":",
                aMessage,
                ",\"Signature-Algorithm\":\"SHA1withRSA\",\"Signature\":\"",
                text,
                "\"}"
            });
        }
        ...
        public static string abcMerChantPayment(string OrderNo,string OrderAmount)
        {
            ...
            tPaymentRequest.dicOrder["ExpiredDate"] = "30";//设定订单保存时间 非必须
         ...
         tPaymentRequest.dicOrder["orderTimeoutDate"] = "20240619104901";                     //设定订单有效期
            ...
            tPaymentRequest.dicRequest["PaymentLinkType"] = "2";      //设定支付接入方式
          ...
          tPaymentRequest.dicRequest["UnionPayLinkType"] = "0";          //当支付类型为6，支付接入方式为2的条件满足时，需要设置银联跨行移动支付接入方式
           ...
           tPaymentRequest.postJSONRequest();
            ...
            //多商户
           //   tPaymentRequest.extendPostJSONRequest(2);
        //    var t= "{\"Version\":\"V3.0.0\",\"Format\":\"JSON\",\"Merchant\":{\"ECMerchantType\":\"EBUS\",\"MerchantID\":\"103881550000267\"},\"TrxRequest\":{\"TrxType\":\"PayReq\",\"PaymentType\":\"1\",\"PaymentLinkType\":\"1\",\"ReceiveAccount\":\"\",\"ReceiveAccName\":\"\",\"NotifyType\":\"1\",\"ResultNotifyURL\":\"http://localhost:4443/abc/ReciveServerPage\",\"MerchantRemarks\":\"\",\"IsBreakAccount\":\"0\",\"SplitAccTemplate\":\"\",\"Order\":{\"PayTypeID\":\"ImmediatePay\",\"OrderNo\":\"ON201706130001\",\"ExpiredDate\":\"20240619104901\",\"OrderAmount\":\"0.01\",\"Fee\":\"\",\"AccountNo\":\"\",\"CurrencyCode\":\"156\",\"ReceiverAddress\":\"\",\"InstallmentMark\":\"0\",\"BuyIP\":\"\",\"OrderDesc\":\"订单说明\",\"OrderURL\":\"\",\"OrderDate\":\"2017/06/13\",\"OrderTime\":\"17:06:13\",\"orderTimeoutDate\":\"\",\"CommodityType\":\"0499\",\"OrderItems\":[{\"SubMerName\":\"慧生活二级商户1\",\"SubMerId\":\"12345\",\"SubMerMCC\":\"0000\",\"SubMerchantRemarks\":\"慧生活\",\"ProductID\":\"IP000001\",\"ProductName\":\"慧生活缴费\",\"UnitPrice\":\"0.01\",\"Qty\":\"1\",\"ProductRemarks\":\"慧生活商品\",\"ProductType\":\"充值类\",\"ProductDiscount\":\"1\",\"ProductExpiredDate\":\"10\"}]}}}";
         //   var cc = com.abc.trustpay.client.MerchantConfig.signMessage(3, t);
      //      var cc1 = fileSignMessage(3, t);
        ...
        public static string abcQueryOrder(string txtOrderNo)
        {
            ...
            tRequest.queryRequest["PayTypeID"] = "ImmediatePay";    //设定交易类型（必要信息）
